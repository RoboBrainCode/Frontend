...
class plot_graph:
	def __init__(self,activity_name,params,taskname):
		self.params = params
	...
	def plotheatmap(self):
		...
		plt.figure()
		plt.imshow(zz)
		fname = "heatmap_task_{0}_activity_{1}.pdf".format(self.taskname,self.activity_name)
		pp = PdfPages("figs/{0}".format(fname))
		plt.savefig(pp, format='pdf')
		pp.close()
		#plt.show()
...
if __name__ == "__main__":
	...
	with open('params/{0}'.format(params_filename),'rb') as ff:
